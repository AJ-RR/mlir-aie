module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<131072xi16>, %arg1: memref<8192xi16>, %arg2: memref<16384xi16>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][2, 1, 128, 8][4096, 32, 32, 1]) {id = 0 : i64, metadata = @C_L2L3_0} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 8, 32, 32][0, 32, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_0} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 8, 32, 8][32, 1024, 32, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 32768][1, 8, 32, 32][0, 32, 256, 1]) {id = 3 : i64, metadata = @A_L3L2_0} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 8, 32, 8][32, 1024, 32, 1]) {id = 4 : i64, metadata = @B_L3L2_0} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][2, 1, 128, 8][4096, 32, 32, 1]) {id = 0 : i64, metadata = @C_L2L3_1} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 8192][1, 8, 32, 32][0, 32, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_1} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 8][1, 8, 32, 8][32, 1024, 32, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 40960][1, 8, 32, 32][0, 32, 256, 1]) {id = 3 : i64, metadata = @A_L3L2_1} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 8][1, 8, 32, 8][32, 1024, 32, 1]) {id = 4 : i64, metadata = @B_L3L2_1} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 16][2, 1, 128, 8][4096, 32, 32, 1]) {id = 0 : i64, metadata = @C_L2L3_2} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 16384][1, 8, 32, 32][0, 32, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_2} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 16][1, 8, 32, 8][32, 1024, 32, 1]) {id = 2 : i64, metadata = @B_L3L2_2} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 49152][1, 8, 32, 32][0, 32, 256, 1]) {id = 3 : i64, metadata = @A_L3L2_2} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 16][1, 8, 32, 8][32, 1024, 32, 1]) {id = 4 : i64, metadata = @B_L3L2_2} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 24][2, 1, 128, 8][4096, 32, 32, 1]) {id = 0 : i64, metadata = @C_L2L3_3} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 24576][1, 8, 32, 32][0, 32, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_3} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 24][1, 8, 32, 8][32, 1024, 32, 1]) {id = 2 : i64, metadata = @B_L3L2_3} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 57344][1, 8, 32, 32][0, 32, 256, 1]) {id = 3 : i64, metadata = @A_L3L2_3} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 24][1, 8, 32, 8][32, 1024, 32, 1]) {id = 4 : i64, metadata = @B_L3L2_3} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8192][2, 1, 128, 8][4096, 32, 32, 1]) {id = 8 : i64, metadata = @C_L2L3_0} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 65536][1, 8, 32, 32][0, 32, 256, 1]) {id = 9 : i64, metadata = @A_L3L2_0} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 8, 32, 8][32, 1024, 32, 1]) {id = 10 : i64, metadata = @B_L3L2_0} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 98304][1, 8, 32, 32][0, 32, 256, 1]) {id = 11 : i64, metadata = @A_L3L2_0} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 8, 32, 8][32, 1024, 32, 1]) {id = 12 : i64, metadata = @B_L3L2_0} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8200][2, 1, 128, 8][4096, 32, 32, 1]) {id = 8 : i64, metadata = @C_L2L3_1} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 73728][1, 8, 32, 32][0, 32, 256, 1]) {id = 9 : i64, metadata = @A_L3L2_1} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 8][1, 8, 32, 8][32, 1024, 32, 1]) {id = 10 : i64, metadata = @B_L3L2_1} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 106496][1, 8, 32, 32][0, 32, 256, 1]) {id = 11 : i64, metadata = @A_L3L2_1} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 8][1, 8, 32, 8][32, 1024, 32, 1]) {id = 12 : i64, metadata = @B_L3L2_1} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8208][2, 1, 128, 8][4096, 32, 32, 1]) {id = 8 : i64, metadata = @C_L2L3_2} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 81920][1, 8, 32, 32][0, 32, 256, 1]) {id = 9 : i64, metadata = @A_L3L2_2} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 16][1, 8, 32, 8][32, 1024, 32, 1]) {id = 10 : i64, metadata = @B_L3L2_2} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 114688][1, 8, 32, 32][0, 32, 256, 1]) {id = 11 : i64, metadata = @A_L3L2_2} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 16][1, 8, 32, 8][32, 1024, 32, 1]) {id = 12 : i64, metadata = @B_L3L2_2} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8216][2, 1, 128, 8][4096, 32, 32, 1]) {id = 8 : i64, metadata = @C_L2L3_3} : memref<16384xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 90112][1, 8, 32, 32][0, 32, 256, 1]) {id = 9 : i64, metadata = @A_L3L2_3} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 24][1, 8, 32, 8][32, 1024, 32, 1]) {id = 10 : i64, metadata = @B_L3L2_3} : memref<8192xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 122880][1, 8, 32, 32][0, 32, 256, 1]) {id = 11 : i64, metadata = @A_L3L2_3} : memref<131072xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 24][1, 8, 32, 8][32, 1024, 32, 1]) {id = 12 : i64, metadata = @B_L3L2_3} : memref<8192xi16>
