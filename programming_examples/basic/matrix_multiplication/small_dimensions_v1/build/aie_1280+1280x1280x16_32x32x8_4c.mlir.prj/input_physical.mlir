module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<1638400xi16>, %arg1: memref<1638400xi16>, %arg2: memref<20480xi16>, %arg3: memref<20480xi16>, %arg4: memref<20480xi16>) {
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 40, 32, 8][16, 512, 16, 1]) {id = 5 : i64, metadata = @B_L3L2_0} : memref<20480xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 163840][1, 40, 64, 32][0, 32, 1280, 1]) {id = 3 : i64, metadata = @A1_L3L2_0} : memref<1638400xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 40, 32, 8][16, 512, 16, 1]) {id = 7 : i64, metadata = @B_L3L2_0} : memref<20480xi16>
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 40, 32, 8][16, 512, 16, 1]) {id = 5 : i64, metadata = @B_L3L2_1} : memref<20480xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 245760][1, 40, 64, 32][0, 32, 1280, 1]) {id = 3 : i64, metadata = @A1_L3L2_1} : memref<1638400xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 40, 32, 8][16, 512, 16, 1]) {id = 7 : i64, metadata = @B_L3L2_1} : memref<20480xi16>
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 40, 32, 8][16, 512, 16, 1]) {id = 13 : i64, metadata = @B_L3L2_0} : memref<20480xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 491520][1, 40, 64, 32][0, 32, 1280, 1]) {id = 11 : i64, metadata = @A1_L3L2_0} : memref<1638400xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 40, 32, 8][16, 512, 16, 1]) {id = 15 : i64, metadata = @B_L3L2_0} : memref<20480xi16>
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 40, 32, 8][16, 512, 16, 1]) {id = 13 : i64, metadata = @B_L3L2_1} : memref<20480xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 573440][1, 40, 64, 32][0, 32, 1280, 1]) {id = 11 : i64, metadata = @A1_L3L2_1} : memref<1638400xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 40, 32, 8][16, 512, 16, 1]) {id = 15 : i64, metadata = @B_L3L2_1} : memref<20480xi16>
