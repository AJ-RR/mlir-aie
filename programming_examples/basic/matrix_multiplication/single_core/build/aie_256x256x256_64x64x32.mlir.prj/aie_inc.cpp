...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd0), /* addrA */ 0x6000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x2400,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd3), /* addrA */ 0xA000,  /* len */ 4096));
...
dma_tile_0_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 16};
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 16};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0x84000,  /* len */ 8192));
...
dma_tile_0_1_bd_3_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 16};
dma_tile_0_1_bd_3_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 16};
dma_tile_0_1_bd_3_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd3), &dma_tile_0_1_bd_3_tensor, 0x86000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x88000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x89000,  /* len */ 4096));
...
dma_tile_0_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 64, /* Size */ 16};
dma_tile_0_1_bd_26_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 8};
dma_tile_0_1_bd_26_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
dma_tile_0_1_bd_26_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd26), &dma_tile_0_1_bd_26_tensor, 0x88000,  /* len */ 4096));
...
dma_tile_0_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 64, /* Size */ 16};
dma_tile_0_1_bd_27_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 8};
dma_tile_0_1_bd_27_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
dma_tile_0_1_bd_27_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd27), &dma_tile_0_1_bd_27_tensor, 0x89000,  /* len */ 4096));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd5), /* addrA */ 0x82000,  /* len */ 8192));
...
dma_tile_0_1_bd_6_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 16};
dma_tile_0_1_bd_6_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_6_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
dma_tile_0_1_bd_6_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd6), &dma_tile_0_1_bd_6_tensor, 0x80000,  /* len */ 8192));
...
dma_tile_0_1_bd_7_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 128, /* Size */ 16};
dma_tile_0_1_bd_7_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_7_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
dma_tile_0_1_bd_7_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd7), &dma_tile_0_1_bd_7_tensor, 0x82000,  /* len */ 8192));
...
const int memC_buff_1_offset = 16384;
...
// buffer memB_cons_buff_0 with unsupported type memref<64x32xi16>;
// buffer memB_cons_buff_1 with unsupported type memref<64x32xi16>;
// buffer memA_cons_buff_0 with unsupported type memref<64x64xi16>;
// buffer memA_cons_buff_1 with unsupported type memref<64x64xi16>;
...
const int memC_cons_buff_1_offset = 8192;
...
// buffer inB_cons_buff_0 with unsupported type memref<64x32xi16>;
// buffer inB_cons_buff_1 with unsupported type memref<64x32xi16>;
// buffer inA_cons_buff_0 with unsupported type memref<64x64xi16>;
// buffer inA_cons_buff_1 with unsupported type memref<64x64xi16>;
