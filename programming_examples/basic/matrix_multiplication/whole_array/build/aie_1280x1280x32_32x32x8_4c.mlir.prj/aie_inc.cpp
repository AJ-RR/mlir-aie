...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd0), &dma_tile_0_1_bd_0_tensor, 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd1), &dma_tile_0_1_bd_1_tensor, 0x81800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd2), /* addrA */ 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x81800,  /* len */ 2048));
...
dma_tile_0_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_0_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_0_1_bd_8_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_0_1_bd_9_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd0), &dma_tile_1_1_bd_0_tensor, 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd1), &dma_tile_1_1_bd_1_tensor, 0x81800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x81800,  /* len */ 2048));
...
dma_tile_1_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_1_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_1_1_bd_8_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_1_1_bd_9_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd0), &dma_tile_2_1_bd_0_tensor, 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd1), &dma_tile_2_1_bd_1_tensor, 0x81800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd2), /* addrA */ 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd3), /* addrA */ 0x81800,  /* len */ 2048));
...
dma_tile_2_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_2_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd0), &dma_tile_3_1_bd_0_tensor, 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd1), &dma_tile_3_1_bd_1_tensor, 0x81800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd2), /* addrA */ 0x81000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x81800,  /* len */ 2048));
...
dma_tile_3_1_bd_26_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
dma_tile_3_1_bd_27_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 8};
...
// buffer C_L1L2_0_3_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_0_3_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_3_0_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_3_0_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L2L3_2_buff_0 with unsupported type memref<1024xi16>;
// buffer C_L2L3_2_buff_1 with unsupported type memref<1024xi16>;
...
// buffer A_L3L2_2_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer A_L3L2_2_cons_buff_1 with unsupported type memref<1024xi16>;
// buffer C_L2L3_3_buff_0 with unsupported type memref<1024xi16>;
// buffer C_L2L3_3_buff_1 with unsupported type memref<1024xi16>;
...
// buffer A_L3L2_3_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer A_L3L2_3_cons_buff_1 with unsupported type memref<1024xi16>;
// buffer C_L1L2_3_3_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_3_3_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_3_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_3_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_3_3_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_3_3_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_2_3_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_2_3_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_3_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_3_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_3_2_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_3_2_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_1_2_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_1_2_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_2_1_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_2_1_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_1_3_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_1_3_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_3_1_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_3_1_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_0_2_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_0_2_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_2_0_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_2_0_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_3_2_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_3_2_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_2_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_2_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_2_3_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_2_3_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_2_1_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_2_1_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_1_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_1_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_1_2_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_1_2_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_0_1_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_0_1_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_1_0_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_1_0_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_2_2_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_2_2_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_2_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_2_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_2_2_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_2_2_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_0_0_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_0_0_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_0_0_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_0_0_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_1_1_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_1_1_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_1_1_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_1_1_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_2_0_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_2_0_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_0_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_2_0_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_0_2_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_0_2_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L1L2_1_0_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_1_0_buff_1 with unsupported type memref<32x8xi16>;
...
// buffer A_L2L1_0_1_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_0_1_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L2L3_0_buff_0 with unsupported type memref<1024xi16>;
// buffer C_L2L3_0_buff_1 with unsupported type memref<1024xi16>;
...
// buffer C_L1L2_3_0_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_3_0_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_0_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_0_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_0_3_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_0_3_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer C_L2L3_1_buff_0 with unsupported type memref<1024xi16>;
// buffer C_L2L3_1_buff_1 with unsupported type memref<1024xi16>;
...
// buffer C_L1L2_3_1_buff_0 with unsupported type memref<32x8xi16>;
// buffer C_L1L2_3_1_buff_1 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_1_cons_buff_0 with unsupported type memref<32x8xi16>;
// buffer B_L2L1_3_1_cons_buff_1 with unsupported type memref<32x8xi16>;
// buffer A_L2L1_1_3_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer A_L2L1_1_3_cons_buff_1 with unsupported type memref<32x32xi16>;
