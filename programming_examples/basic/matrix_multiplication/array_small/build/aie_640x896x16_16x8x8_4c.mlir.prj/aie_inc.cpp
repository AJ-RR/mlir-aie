...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile02_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd1), /* addrA */ 0x700,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile02_bd2), /* addrA */ 0x400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,2), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile12_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile12_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile03_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile03_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile03_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,3), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile13_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile13_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile13_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile13_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile13_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,3), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile04_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile04_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile04_bd2), /* addrA */ 0x400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,4), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile14_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile14_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile14_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile14_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile14_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,4), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile05_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile05_bd2), /* addrA */ 0x400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,5), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile15_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile15_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile15_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile15_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile15_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,5), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
__mlir_aie_try(XAie_DmaChannelEnable(&(ctx->DevInst), XAie_TileLoc(1,5), /* ChNum */ 1, /* dmaDir */ DMA_S2MM));
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,5), /* ChNum */0, /* dmaDir */ DMA_MM2S, /* BdNum */2, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile22_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile22_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile32_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile32_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile32_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,2), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile23_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile23_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile23_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile23_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile23_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,3), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile33_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile33_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile33_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile24_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile24_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile24_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile24_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile24_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,4), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile34_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile34_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile34_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile25_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile25_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile25_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile25_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile35_bd1), XAie_LockInit(2,-1),XAie_LockInit(3,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd1), /* addrA */ 0x700,  /* len */ 128));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile35_bd1),  /* nextbd */ 1,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile35_bd2), /* addrA */ 0x400,  /* len */ 512));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile35_bd2),  /* nextbd */ 2,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,5), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd0), &dma_tile_0_1_bd_0_tensor, 0x80800,  /* len */ 0));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd24), &dma_tile_0_1_bd_24_tensor, 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd1), XAie_LockInit(64,-2),XAie_LockInit(65,2)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x80900,  /* len */ 128));
...
dma_tile_0_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 2};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0x80900,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd3), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd26), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd26), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd4), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd27), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd27), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile01_bd28), XAie_LockInit(69,-4),XAie_LockInit(68,4)));
XAie_DmaTensor dma_tile_0_1_bd_28_tensor = {};
dma_tile_0_1_bd_28_tensor.NumDim = 4;
dma_tile_0_1_bd_28_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_0_1_bd_28_tensor.Dim){
  return 1;
}
dma_tile_0_1_bd_28_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_28_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_0_1_bd_28_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_0_1_bd_28_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd28), &dma_tile_0_1_bd_28_tensor, 0x80000,  /* len */ 2048));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile01_bd28),  /* nextbd */ 28,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */0, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */2, /* dmaDir */ DMA_S2MM, /* BdNum */3, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */4, /* dmaDir */ DMA_S2MM, /* BdNum */4, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(0,1), /* ChNum */3, /* dmaDir */ DMA_MM2S, /* BdNum */28, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd0), &dma_tile_1_1_bd_0_tensor, 0x80800,  /* len */ 0));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd24), &dma_tile_1_1_bd_24_tensor, 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd1), XAie_LockInit(64,-2),XAie_LockInit(65,2)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd1), /* addrA */ 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd25), /* addrA */ 0x80900,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd2), XAie_LockInit(67,-1),XAie_LockInit(66,1)));
XAie_DmaTensor dma_tile_1_1_bd_2_tensor = {};
dma_tile_1_1_bd_2_tensor.NumDim = 4;
dma_tile_1_1_bd_2_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_1_1_bd_2_tensor.Dim){
  return 1;
}
dma_tile_1_1_bd_2_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_1_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 2};
dma_tile_1_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_1_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd2), &dma_tile_1_1_bd_2_tensor, 0x80900,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd3), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd26), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd26), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd4), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd27), XAie_LockInit(68,-1),XAie_LockInit(69,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd27), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile11_bd28), XAie_LockInit(69,-4),XAie_LockInit(68,4)));
XAie_DmaTensor dma_tile_1_1_bd_28_tensor = {};
dma_tile_1_1_bd_28_tensor.NumDim = 4;
dma_tile_1_1_bd_28_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_1_1_bd_28_tensor.Dim){
  return 1;
}
dma_tile_1_1_bd_28_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_1_1_bd_28_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_1_1_bd_28_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_1_1_bd_28_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd28), &dma_tile_1_1_bd_28_tensor, 0x80000,  /* len */ 2048));
__mlir_aie_try(XAie_DmaSetNextBd(&(dma_tile11_bd28),  /* nextbd */ 28,  /* enableNextBd */ 1));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,1), /* ChNum */0, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
__mlir_aie_try(XAie_DmaChannelEnable(&(ctx->DevInst), XAie_TileLoc(1,1), /* ChNum */ 0, /* dmaDir */ DMA_S2MM));
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,1), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */25, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,1), /* ChNum */2, /* dmaDir */ DMA_S2MM, /* BdNum */3, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,1), /* ChNum */3, /* dmaDir */ DMA_MM2S, /* BdNum */28, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd0), &dma_tile_2_1_bd_0_tensor, 0x80800,  /* len */ 0));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd24), &dma_tile_2_1_bd_24_tensor, 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile21_bd1), XAie_LockInit(64,-2),XAie_LockInit(65,2)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd1), /* addrA */ 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd25), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile21_bd2), XAie_LockInit(66,-1),XAie_LockInit(67,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd2), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd26), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile21_bd3), XAie_LockInit(66,-1),XAie_LockInit(67,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd3), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile21_bd4), XAie_LockInit(67,-4),XAie_LockInit(66,4)));
XAie_DmaTensor dma_tile_2_1_bd_4_tensor = {};
dma_tile_2_1_bd_4_tensor.NumDim = 4;
dma_tile_2_1_bd_4_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_2_1_bd_4_tensor.Dim){
  return 1;
}
dma_tile_2_1_bd_4_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_2_1_bd_4_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_2_1_bd_4_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_2_1_bd_4_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd4), &dma_tile_2_1_bd_4_tensor, 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,1), /* ChNum */0, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd0), &dma_tile_3_1_bd_0_tensor, 0x80800,  /* len */ 0));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd24), &dma_tile_3_1_bd_24_tensor, 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd1), /* addrA */ 0x80800,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd25), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile31_bd2), XAie_LockInit(66,-1),XAie_LockInit(67,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd2), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd26), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile31_bd3), XAie_LockInit(66,-1),XAie_LockInit(67,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile31_bd4), XAie_LockInit(67,-4),XAie_LockInit(66,4)));
XAie_DmaTensor dma_tile_3_1_bd_4_tensor = {};
dma_tile_3_1_bd_4_tensor.NumDim = 4;
dma_tile_3_1_bd_4_tensor.Dim =__mlir_aie_alloc_dim_desc(4);
if(NULL == dma_tile_3_1_bd_4_tensor.Dim){
  return 1;
}
dma_tile_3_1_bd_4_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_3_1_bd_4_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 4};
dma_tile_3_1_bd_4_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 16, /* Size */ 2};
dma_tile_3_1_bd_4_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd4), &dma_tile_3_1_bd_4_tensor, 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,1), /* ChNum */0, /* dmaDir */ DMA_S2MM, /* BdNum */1, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
__mlir_aie_try(XAie_DmaChannelEnable(&(ctx->DevInst), XAie_TileLoc(3,1), /* ChNum */ 0, /* dmaDir */ DMA_S2MM));
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,1), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */25, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(2, 4)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(4, 1)));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(2, 4)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(4, 1)));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,1), XAie_LockInit(4, 4)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,1), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,5), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,5), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,4), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,4), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(4, 1)));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(4, 4)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,1), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,5), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,4), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,3), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(4, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(5, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,3), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,4), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,4), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,5), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,5), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(1,1), XAie_LockInit(2, 1)));
...
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(2, 1)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(3, 0)));
__mlir_aie_try(XAie_LockSetValue(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(2, 1)));
...
y = 5;
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 5, DMA, 0));
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), WEST, 3, EAST, 2));
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 2, DMA, 1));
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), DMA, 0, SOUTH, 0));
...
// buffer P_L3L2_2_cons_buff_0 with unsupported type memref<128xi16>;
...
// buffer P_L3L2_3_cons_buff_0 with unsupported type memref<128xi16>;
...
// buffer P_L2L1_3_1_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_3_0_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_2_1_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_1_0_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_2_0_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_0_0_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_0_1_cons_buff_0 with unsupported type memref<16x8xi16>;
...
// buffer P_L2L1_1_1_cons_buff_0 with unsupported type memref<16x8xi16>;
...
int mlir_aie_acquire_P_L3L2_3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,1), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L3L2_2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L3L2_2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_3_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_3_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_3_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_3_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_3_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_3_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_3_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_3_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,5), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_2_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_2_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_2_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_2_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_2_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_2_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_2_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_2_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,4), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_1_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_1_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_1_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_1_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_1_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_1_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_1_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_1_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,3), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_0_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_0_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_0_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_0_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_0_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_0_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_P_L2L1_0_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_P_L2L1_0_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
