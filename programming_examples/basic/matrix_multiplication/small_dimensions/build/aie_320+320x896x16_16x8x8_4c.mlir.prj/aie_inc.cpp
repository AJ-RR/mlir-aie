...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd1), &dma_tile_0_1_bd_1_tensor, 0x81200,  /* len */ 256));
...
dma_tile_0_1_bd_24_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd24), &dma_tile_0_1_bd_24_tensor, 0x81100,  /* len */ 256));
...
dma_tile_0_1_bd_25_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd25), &dma_tile_0_1_bd_25_tensor, 0x81300,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd2), /* addrA */ 0x81000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd3), /* addrA */ 0x81200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd26), /* addrA */ 0x81400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd27), /* addrA */ 0x81480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd4), &dma_tile_0_1_bd_4_tensor, 0x81400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd5), &dma_tile_0_1_bd_5_tensor, 0x81480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd6), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd7), /* addrA */ 0x80800,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd8), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd9), /* addrA */ 0x80C00,  /* len */ 512));
...
dma_tile_0_1_bd_32_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd32), &dma_tile_0_1_bd_32_tensor, 0x80000,  /* len */ 2048));
...
dma_tile_0_1_bd_33_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd33), &dma_tile_0_1_bd_33_tensor, 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd1), &dma_tile_1_1_bd_1_tensor, 0x81200,  /* len */ 256));
...
dma_tile_1_1_bd_24_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd24), &dma_tile_1_1_bd_24_tensor, 0x81100,  /* len */ 256));
...
dma_tile_1_1_bd_25_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd25), &dma_tile_1_1_bd_25_tensor, 0x81300,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd2), /* addrA */ 0x81000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x81200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd26), /* addrA */ 0x81400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd27), /* addrA */ 0x81480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd4), &dma_tile_1_1_bd_4_tensor, 0x81400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd5), &dma_tile_1_1_bd_5_tensor, 0x81480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd6), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd7), /* addrA */ 0x80800,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd8), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd9), /* addrA */ 0x80C00,  /* len */ 512));
...
dma_tile_1_1_bd_32_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd32), &dma_tile_1_1_bd_32_tensor, 0x80000,  /* len */ 2048));
...
dma_tile_1_1_bd_33_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile11_bd33), &dma_tile_1_1_bd_33_tensor, 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd1), &dma_tile_2_1_bd_1_tensor, 0x81200,  /* len */ 256));
...
dma_tile_2_1_bd_24_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd24), &dma_tile_2_1_bd_24_tensor, 0x81100,  /* len */ 256));
...
dma_tile_2_1_bd_25_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile21_bd25), &dma_tile_2_1_bd_25_tensor, 0x81300,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd2), /* addrA */ 0x81000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd3), /* addrA */ 0x81200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd26), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd27), /* addrA */ 0x80800,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd4), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd5), /* addrA */ 0x80A00,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd28), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd29), /* addrA */ 0x80C00,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd6), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd7), /* addrA */ 0x80E00,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd1), &dma_tile_3_1_bd_1_tensor, 0x81200,  /* len */ 256));
...
dma_tile_3_1_bd_24_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd24), &dma_tile_3_1_bd_24_tensor, 0x81100,  /* len */ 256));
...
dma_tile_3_1_bd_25_tensor.Dim[3].AieMlDimDesc = { /* Stride */ 16, /* Size */ 4};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile31_bd25), &dma_tile_3_1_bd_25_tensor, 0x81300,  /* len */ 256));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd2), /* addrA */ 0x81000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x81200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd26), /* addrA */ 0x80000,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd27), /* addrA */ 0x80800,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd4), /* addrA */ 0x80200,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd5), /* addrA */ 0x80A00,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd28), /* addrA */ 0x80400,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd29), /* addrA */ 0x80C00,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd6), /* addrA */ 0x80600,  /* len */ 512));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd7), /* addrA */ 0x80E00,  /* len */ 512));
...
// buffer A1_L2L1_3_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_3_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L3L2_0_cons_buff_0 with unsupported type memref<256xi16>;
// buffer A2_L3L2_0_cons_buff_1 with unsupported type memref<256xi16>;
...
// buffer A2_L3L2_1_cons_buff_0 with unsupported type memref<256xi16>;
// buffer A2_L3L2_1_cons_buff_1 with unsupported type memref<256xi16>;
...
// buffer A2_L2L1_3_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_3_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L2L1_3_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_3_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_2_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_2_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_3_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_3_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_2_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_2_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L2L1_2_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_2_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L2L1_1_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_1_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_1_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_1_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L2L1_2_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_2_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_0_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_0_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_1_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_1_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A2_L2L1_0_0_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_0_0_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L2L1_0_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A1_L2L1_0_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L3L2_0_cons_buff_0 with unsupported type memref<256xi16>;
// buffer A1_L3L2_0_cons_buff_1 with unsupported type memref<256xi16>;
...
// buffer A2_L2L1_0_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_0_1_cons_buff_1 with unsupported type memref<16x8xi16>;
...
// buffer A1_L3L2_1_cons_buff_0 with unsupported type memref<256xi16>;
// buffer A1_L3L2_1_cons_buff_1 with unsupported type memref<256xi16>;
...
// buffer A2_L2L1_1_1_cons_buff_0 with unsupported type memref<16x8xi16>;
// buffer A2_L2L1_1_1_cons_buff_1 with unsupported type memref<16x8xi16>;
