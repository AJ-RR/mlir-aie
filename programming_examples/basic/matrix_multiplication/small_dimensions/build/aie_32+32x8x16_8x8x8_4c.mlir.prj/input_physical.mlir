module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<256xi16>, %arg1: memref<256xi16>, %arg2: memref<128xi16>, %arg3: memref<1024xi32>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 0][1, 1, 32, 8][512, 16, 16, 1]) {id = 0 : i64, metadata = @C_L2L3_0} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 1, 16, 8][0, 8, 8, 1]) {id = 1 : i64, metadata = @A1_L3L2_0} : memref<256xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<128xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 8][1, 1, 32, 8][512, 16, 16, 1]) {id = 0 : i64, metadata = @C_L2L3_1} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 128][1, 1, 16, 8][0, 8, 8, 1]) {id = 1 : i64, metadata = @A1_L3L2_1} : memref<256xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 1, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<128xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 16][1, 1, 32, 8][512, 16, 16, 1]) {id = 0 : i64, metadata = @C_L2L3_2} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 1, 16, 8][0, 8, 8, 1]) {id = 1 : i64, metadata = @A2_L3L2_0} : memref<256xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 24][1, 1, 32, 8][512, 16, 16, 1]) {id = 0 : i64, metadata = @C_L2L3_3} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 128][1, 1, 16, 8][0, 8, 8, 1]) {id = 1 : i64, metadata = @A2_L3L2_1} : memref<256xi16>
