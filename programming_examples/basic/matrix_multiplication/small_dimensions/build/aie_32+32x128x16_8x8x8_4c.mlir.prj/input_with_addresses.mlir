module {
  aie.device(npu1_4col) {
    ...
    ^bb6(%5: index):  // 2 preds: ^bb5, ^bb7
      %6 = arith.cmpi slt, %5, %c16_4 : index
    ...
    ^bb10(%9: index):  // 2 preds: ^bb9, ^bb11
      %10 = arith.cmpi slt, %9, %c16_8 : index
    ...
    aiex.runtime_sequence(%arg0: memref<4096xi16>, %arg1: memref<4096xi16>, %arg2: memref<2048xi16>, %arg3: memref<512xi32>, %arg4: memref<512xi32>) {
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 16, 16, 8][0, 8, 128, 1]) {id = 1 : i64, metadata = @A1_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 16, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<2048xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 8][1, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C1_L2L3_1} : memref<512xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 2048][1, 16, 16, 8][0, 8, 128, 1]) {id = 1 : i64, metadata = @A1_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 16, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<2048xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 0][1, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C2_L2L3_0} : memref<512xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 16, 16, 8][0, 8, 128, 1]) {id = 1 : i64, metadata = @A2_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 8][1, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C2_L2L3_1} : memref<512xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 2048][1, 16, 16, 8][0, 8, 128, 1]) {id = 1 : i64, metadata = @A2_L3L2_1} : memref<4096xi16>
