module {
  aie.device(npu1_4col) {
    ...
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[1024, 0, 0, 4194304, -2130706369, 3, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[512, 0, 0, 4194304, -2139095033, 63, 0, 33554432]>
    aiex.runtime_sequence(%arg0: memref<4096xi16>, %arg1: memref<4096xi16>, %arg2: memref<2048xi16>, %arg3: memref<512xi32>, %arg4: memref<512xi32>) {
      ...
      aiex.npu.address_patch {addr = 33673252 : ui32, arg_idx = 0 : i32, arg_plus = 4096 : i32}
      ...
      aiex.npu.address_patch {addr = 100782116 : ui32, arg_idx = 1 : i32, arg_plus = 4096 : i32}
