module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<1024xi16>, %arg1: memref<1024xi16>, %arg2: memref<512xi16>, %arg3: memref<512xi32>, %arg4: memref<512xi32>) {
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A1_L3L2_0} : memref<1024xi16>
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 512][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A1_L3L2_1} : memref<1024xi16>
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A2_L3L2_0} : memref<1024xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 8][1, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C2_L2L3_1} : memref<512xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 512][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A2_L3L2_1} : memref<1024xi16>
