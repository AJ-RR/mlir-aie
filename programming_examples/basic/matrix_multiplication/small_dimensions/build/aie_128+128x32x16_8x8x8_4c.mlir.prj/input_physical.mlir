module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence(%arg0: memref<4096xi16>, %arg1: memref<4096xi16>, %arg2: memref<512xi16>, %arg3: memref<2048xi32>, %arg4: memref<2048xi32>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 0][2, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C1_L2L3_0} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A1_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 4, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 1024][1, 4, 16, 8][0, 8, 32, 1]) {id = 3 : i64, metadata = @A1_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 4, 8, 8][32, 128, 16, 1]) {id = 4 : i64, metadata = @B_L3L2_0} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 8][2, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C1_L2L3_1} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 512][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A1_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 4, 8, 8][32, 128, 16, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 1536][1, 4, 16, 8][0, 8, 32, 1]) {id = 3 : i64, metadata = @A1_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 4, 8, 8][32, 128, 16, 1]) {id = 4 : i64, metadata = @B_L3L2_1} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 0][2, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C2_L2L3_0} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A2_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 1024][1, 4, 16, 8][0, 8, 32, 1]) {id = 3 : i64, metadata = @A2_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 8][2, 1, 32, 8][512, 32, 16, 1]) {id = 0 : i64, metadata = @C2_L2L3_1} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 512][1, 4, 16, 8][0, 8, 32, 1]) {id = 1 : i64, metadata = @A2_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 1536][1, 4, 16, 8][0, 8, 32, 1]) {id = 3 : i64, metadata = @A2_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 1024][2, 1, 32, 8][512, 32, 16, 1]) {id = 8 : i64, metadata = @C1_L2L3_0} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 2048][1, 4, 16, 8][0, 8, 32, 1]) {id = 9 : i64, metadata = @A1_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 4, 8, 8][32, 128, 16, 1]) {id = 10 : i64, metadata = @B_L3L2_0} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 3072][1, 4, 16, 8][0, 8, 32, 1]) {id = 11 : i64, metadata = @A1_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 4, 8, 8][32, 128, 16, 1]) {id = 12 : i64, metadata = @B_L3L2_0} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg3[0, 0, 0, 1032][2, 1, 32, 8][512, 32, 16, 1]) {id = 8 : i64, metadata = @C1_L2L3_1} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 2560][1, 4, 16, 8][0, 8, 32, 1]) {id = 9 : i64, metadata = @A1_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 4, 8, 8][32, 128, 16, 1]) {id = 10 : i64, metadata = @B_L3L2_1} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 3584][1, 4, 16, 8][0, 8, 32, 1]) {id = 11 : i64, metadata = @A1_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 8][1, 4, 8, 8][32, 128, 16, 1]) {id = 12 : i64, metadata = @B_L3L2_1} : memref<512xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 1024][2, 1, 32, 8][512, 32, 16, 1]) {id = 8 : i64, metadata = @C2_L2L3_0} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 2048][1, 4, 16, 8][0, 8, 32, 1]) {id = 9 : i64, metadata = @A2_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 3072][1, 4, 16, 8][0, 8, 32, 1]) {id = 11 : i64, metadata = @A2_L3L2_0} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg4[0, 0, 0, 1032][2, 1, 32, 8][512, 32, 16, 1]) {id = 8 : i64, metadata = @C2_L2L3_1} : memref<2048xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 2560][1, 4, 16, 8][0, 8, 32, 1]) {id = 9 : i64, metadata = @A2_L3L2_1} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 3584][1, 4, 16, 8][0, 8, 32, 1]) {id = 11 : i64, metadata = @A2_L3L2_1} : memref<4096xi16>
